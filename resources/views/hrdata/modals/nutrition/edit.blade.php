<!-- Edit Modal -->
<div style="text-align: left ;vertical-align:baseline" class="modal fade" id="edit-hrnutrition{{ $nutrition['id'] }}"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frmUser" data-toggle="validator"
                      action="{{ route('hrnutrition.edit', ['id' =>$nutrition['id']]) }}" method="PUT">
                    {{csrf_field()}}
                    {{ method_field('PUT') }}
                    <div class="row">
                            ...
                            <select name="diagnose_id" id="diagnose_id" class="form-control" required>
                                ...
                                @foreach($diagnoses as $diagnose)
                                    <option value="{{$diagnose}}"
                                            @if($diagnose==$nutrition['diagnose_id']) selected='selected' @endif>{{\App\HRDiagnose::find($diagnose)['diagnose']}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn crud-submit btn-success" id="btnEditHRNutrition"
                                name="btnEditHRNutrition">Lưu
                        </button>
                    </div>
                </form>
            </div>
