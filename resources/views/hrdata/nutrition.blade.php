                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <button type="button" class="btn btn-sm btn-primary"
                                    data-toggle="modal" data-target="#create-hrnutrition">Tạo chế độ dinh dưỡng
                            </button>
                            @include('hrdata.modals.nutrition.add')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button data-toggle="modal"
                                                    ...
                                                    class="btn btn-sm btn-success">Sửa
                                            </button>
                                            @include('hrdata.modals.nutrition.edit')
                                        </td>
                                        <td>
                                            <button data-toggle="modal"
                                                    data-target="#delete-hrnutrition{{ $nutrition['id'] }}"
                                                    type="button" class="btn btn-sm btn-warning">Xóa
                                            </button>
                                            @include('hrdata.modals.nutrition.delete')
                                        </td>
                                    </tr>
